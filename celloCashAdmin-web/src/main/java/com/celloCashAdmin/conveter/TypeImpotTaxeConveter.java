...
@FacesConverter(value = "typeImpotTaxeConverter")
public class TypeImpotTaxeConveter implements Converter{
    ...
    public Object getAsObject(FacesContext ctx, UIComponent uiComponent, String arg2) {
       try {
			...
			if (arg2 != null && !arg2.trim().equals("")) {
				return new FactoryBean().getTypeImpotTaxeService().getDetail(Long.parseLong(arg2));
			} else {
				return null;
			}
		} catch (Exception e) {
    ...
    public String getAsString(FacesContext facesContext, UIComponent uiComponent, Object arg2) {
      if (arg2 != null && arg2 !="") {
			...
			TypeImpotTaxe tit = (TypeImpotTaxe) arg2;
			if (tit != null && tit.getId()!= null) {
				return "" + tit.getId();
			}
			return null;
