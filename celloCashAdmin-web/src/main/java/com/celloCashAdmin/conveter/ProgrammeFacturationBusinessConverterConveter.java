...
@FacesConverter(value = "programmeFacturationBusinessConverter")
public class ProgrammeFacturationBusinessConverterConveter implements Converter{
    @Override
    public Object getAsObject(FacesContext arg0, UIComponent arg1, String arg2) {
        ...
        try {
            ...
            if (arg2 != null && !arg2.trim().equals("")) {
                ...
                return new FactoryBean().getProgrammeFacturationBusinessService().get(Long.parseLong(arg2));
            } else {
                return null;
            }
        } catch (Exception e) {
    ...
    public String getAsString(FacesContext arg0, UIComponent arg1, Object arg2) {
        if (arg2 != null) {
            ...
            ProgrammeFacturationBusiness item = (ProgrammeFacturationBusiness) arg2;
